...
import { getAllAppointment, GetAppoitmentById, createAppointment, DeleteAppoitnment, updateAppoitnment, searchAppointment, updateStatus } from "../controllers/appointment"
